var LateralMap = (function() {
    /**
     * Module providing lateral map visualization.
     */
    ...
    Map.prototype.setForces = function() {
         ...
         *   link: force generated by edges. Connected nodes want to be close.
         *   charge: nodes are repelled.
         *   machine: nodes representing machine names are strongly repelled.
         *   centering: pulling graph to the center of plane (not screen).
         *       This is not really a force, but clever translation.
         */
        var THAT = this;
    ...
    Map.prototype.filterEvents = function(fromTime, toTime) {
         ...
         * effect. This is done by setFileter function.
         */
    ...
    Map.prototype.clusterRoutine = function(cluster_id){
        /**
         * Set correct visibility for nodes and labels;
         */
        var THAT = this;
        ...
        // Hides links that would connect the same node.
    ...
    Map.prototype.merge = function(cluster_id){
         ...
         *
         * They are not actually merged. Nodes are hidden and edges are
    ...
    Map.prototype.renderButtons = function(){
        /**
         * Renders button for basic control (merging, filtering, stopping).
         */
        var THAT = this;
    ...
    Map.prototype.render = function(data, element, renderButtons=false) {
        /**
         * Renders actual graph in html element based on data.
         */
    ...
    Map.prototype.resetOpacity = function() {
        /**
         * Sets opacity of elements to their initial value.
         */
    ...
    Map.prototype.accessDfs = function(d) {
        /**
         * Finds all nodes that are reachable from d by exactly one or zero
         * 'access' links/edges.
         * d can be array of nodes or one node.
         */
        var done = new Set();
    ...
    Map.prototype.getRealTarget = function(node){
        /**
         * Returns the same node, or node representing cluster center, if
         * the current cluster is merged.
         */
    ...
    function collide(node, scale) {
        ...
        return function(tree, x1, y1, x2, y2) {
            /**
             * Gets subquadtree and current bounding box.
            ...
            if(xOverlap > 0 && yOverlap > 0) {
                if('data' in tree && (tree.data !== node)) {
                    ...
                    var point = tree.data,
                        pxPadding = point.width*0.02 / scale,
                    ...
                    if(absX < xSpacing && absY < ySpacing) {
                        ...
                        // Move only in one dimension. If two nodes just barely
                        // overlap at y-dimension and greatly at x, it is better
                        // o just move in y.
    ...
    function filteredManyBody(){
        /**
         * Repulsive force between all machine identifiers (machine_name and
         * machine_ip).
         */
    ...
    function linkLength(link) {
        /**
         * Specifies proffered link length.
         */
        var maper = {
            'has': 10,
            'is': 10,
