...
class ParserManagerTest(unittest.TestCase):
  """Tests parser management and parsing."""
  ...
  def test_SysLogLine(self):
    """Tests parser for syslog:line data_type."""
    expected = [
  ...
  _linux_utmp_event = {
      ...
      u'message': (
          u'User: dean Computer Name: 192.168.1.11 Terminal: pts/0 PID: 16304 '
          u'Terminal_ID: 808416116 Status: USER_PROCESS IP Address: '
          u'192.168.1.11 Exit: 0'),
      u'offset': 384,
      u'parser': u'utmp',
      u'pathspec': {
          ...
          u'parent': {
              ...
              u'parent': {
                  ...
                  u'parent': {
                      u'__type__': u'PathSpec',
                      u'location': u'/usr/user/images/acserver.dd',
  ...
  _win_evtx_event = {
      ...
      u'strings': [
          ...
          u'{00000000-0000-0000-0000-000000000000}', u'-', u'NTLM V1', u'128',
          u'0x0000000000000000', u'-', u'192.168.1.11', u'49192'],
  ...
  _bsm_event = {
      ...
      u'extra_tokens': (
          u'[BSM_TOKEN_SUBJECT32_EX: aid(502), euid(502), egid(20), uid(502), '
          u'gid(20), pid(5023), session_id(5023), terminal_port(49539), '
          u'terminal_ip(192.168.1.11)]. [BSM_TOKEN_TEXT: successful login '
          u'dean]. [BSM_TOKEN_RETURN32: Success (0), System call status: 0]'),
      u'filename': u'/private/var/audit/20150825205628.crash_recovery',
      u'inode': 0,
      u'message': (
          u'Type: OpenSSH login (32800) event_data: [BSM_TOKEN_SUBJECT32_EX: '
          u'aid(502), euid(502), egid(20), uid(502), gid(20), pid(5023), '
          u'session_id(5023), terminal_port(49539), '
          u'terminal_ip(192.168.1.11)]. [BSM_TOKEN_TEXT: successful login '
          u'dean]. [BSM_TOKEN_RETURN32: Success (0), System call status: 0]'),
      u'offset': 132254,
      u'parser': u'bsm_log',
      u'pathspec': {
          u'__type__': u'PathSpec',
          u'inode': 1299851,
          u'location': u'/private/var/audit/20150825205628.crash_recovery',
          u'parent': {
              u'__type__': u'PathSpec',
              u'location': u'/p2',
              u'parent': {
                  ...
                  u'parent': {
                      u'__type__': u'PathSpec',
                      u'location': u'/media/greendale_images/dean_mac.dd',
                      u'type_indicator': u'OS'},
                  u'type_indicator': u'RAW'},
              u'part_index': 5,
  ...
  _sys_log_event = {
      ...
      u'inode': 0,
      u'message': (
          u'[sshd, pid: 6686] Accepted password for dean from 10.0.8.6 port '
          u'52666 ssh2'),
      u'offset': 0,
      u'parser': u'syslog',
      u'pathspec': {
  ...
  _sys_log_ssh = {
      ...
      u'body': (
          u'Accepted publickey for dean from 10.0.8.6 port 52673 ssh2: RSA '
          u'a5:ed:32:56:6e:cb:be:88:70:1d:88:4f:9b:ce:bf:d1'),
      ...
      u'inode': 0,
      u'message': (
          u'Successful login of user: deanfrom 10.0.8.6:52673using '
          u'authentication method: publickeyssh pid: 6844'),
      u'offset': 0,
      u'parser': u'syslog',
      u'pathspec': {
          u'__type__': u'PathSpec',
